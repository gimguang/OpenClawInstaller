...
<p align="center">
  <a href="https://github.com/gimguang/openclaw-manager">
...
👉 **下载地址**: [github.com/gimguang/openclaw-manager](https://github.com/gimguang/openclaw-manager)
...
```bash
# 1. 克隆仓库
git clone https://github.com/gimguang/OpenClawInstaller.git
...
# 或从 GitHub 下载运行
curl -fsSL https://raw.githubusercontent.com/gimguang/OpenClawInstaller/main/config-menu.sh | bash
```
...
- [🖥️ OpenClaw Manager 桌面版](https://github.com/gimguang/openclaw-manager) - 图形界面管理工具
- [安装工具仓库](https://github.com/gimguang/OpenClawInstaller) - 命令行版本
- [OpenClaw 主仓库](https://github.com/openclaw/openclaw)
- [社区讨论](https://github.com/gimguang/OpenClawInstaller/discussions)

---

<p align="center">
  Made with ❤️ by <a href="https://github.com/gimguang">gimguang</a>
</p>
